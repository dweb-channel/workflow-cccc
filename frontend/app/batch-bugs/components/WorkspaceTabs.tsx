  ...
  return (
    <>
      <div className="flex items-center gap-1 overflow-x-auto scrollbar-none">
        {loading ? (
          <span className="px-3 py-1 text-xs text-muted-foreground">加载中...</span>
        ) : error ? (
            ...
            return (
              <div
                ...
                className={`group relative flex shrink-0 items-center gap-1.5 rounded-full px-3 py-1 text-xs cursor-pointer transition-all ${
                  isActive
                    ? "bg-primary/10 text-primary ring-1 ring-ring/30"
              ...
              >
                ...
                <span className={`text-[10px] ${isActive ? "text-primary" : "text-muted-foreground"}`}>{ws.job_count}</span>
