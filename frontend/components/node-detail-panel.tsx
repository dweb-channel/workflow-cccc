...
export function NodeDetailPanel({ node, onClose }: NodeDetailPanelProps) {
  ...
  return (
    <div className="fixed inset-y-0 right-0 z-50 flex w-[400px] flex-col border-l bg-white shadow-xl">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {/* Node ID */}
        <div className="mb-4">
          <h3 className="mb-2 text-sm font-medium text-slate-500">节点 ID</h3>
          <code className="rounded bg-slate-100 px-2 py-1 text-xs">{node.id}</code>
        </div>

        {/* Input */}
        <div className="mb-4">
          <h3 className="mb-2 text-sm font-medium text-slate-500">📥 输入</h3>
        ...
        {/* Output */}
        <div className="mb-4">
          <h3 className="mb-2 text-sm font-medium text-slate-500">📤 输出</h3>
          <div className="rounded-lg bg-slate-50 p-3">
            {decodedOutput ? (
              <div className="max-h-[400px] overflow-auto text-sm text-slate-700 prose prose-sm prose-slate max-w-none">
